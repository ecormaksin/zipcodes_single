...
public final class PrefectureTestUtil {
    ...
    public static final String PREFECTURE_CODE_STR_TOKYO = PREFECTURE_CODE_TOKYO.getValue();
    ...
    public static final String PREFECTURE_CODE_STR_NOT_EXIST = PREFECTURE_CODE_NOT_EXIST.getValue();
